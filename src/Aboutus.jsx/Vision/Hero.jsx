...
import img from '../../Assets/vision1.jpg'
...
export default function Hero() {
  return (
    ...
    <div className='bg-[#00000070] h-[230px] md:h-[200px] w-full flex items-center justify-center flex-wrap'>
        <div className='flex flex-col items-center  '>
          <h1 className='text-5xl font-semibold my-4 text-white'>Company Vision and Mission</h1>

...
import img from '../../Assets/epm1.jpg'
  ...
  return (
    ...
    <div className='bg-[#000000b2] h-[230px] md:h-[200px] w-full flex items-center justify-center flex-wrap'>
        <div className='flex flex-col items-center  '>
          <h1 className='text-5xl font-semibold my-4 text-white'> Enterprise Performance Management (EPM)</h1>
          ...
          <div className='flex items-center mx-5 '>
            ...
            <IoIosArrowForward  className='text-white'/>
            <h1  className='text-xs font-medium text-white'>Enterprise Performance Management (EPM)</h1>

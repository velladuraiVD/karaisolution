    ...
    return (
        <div className='flex flex-col justify-center items-center flex-wrap' >
            ...
            <div className='  flex flex-row justify-center flex-wrap'>
                <div className=' sm:w-[300px] h-[320px] md:w-[300px] p-2 bg-[#ffff] shadow-[1px_0px_10px_1px] shadow-slate-500 m-4 hover:-translate-y-4 duration-500 hover:shadow-[0px_3px_10px_0px]  '>
                ...
                <div className='sm:w-[300px] h-[320px] md:w-[300px] p-2 bg-[#ffff] shadow-[1px_0px_30px_1px]  shadow-slate-500 m-4 hover:-translate-y-4 duration-500 hover:shadow-[0px_3px_10px_0px] '>

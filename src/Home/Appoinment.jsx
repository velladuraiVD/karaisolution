...
export default function Appoinment() {
  return (
    ...
    <div style={{ backgroundImage: `url(${img})`,  }} className='sm:auto md:h-[500px] w-auto bg-cover overflow-hidden flex-col flex flex-wrap  '>
      <div className='bg-[#000000a6] flex justify-between items-center h-full flex-wrap'>
        <div>

        </div>
        <div className='sm:auto md:w-[700px] mt-36 sm:m-8 '>

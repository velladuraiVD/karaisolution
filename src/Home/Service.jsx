    ...
    return (
        <div>
            <div className='m-10'>
                ...
                <p className='text-xl font-semibold mx-10'> Kar Ai Solutions is the best counseling accomplice for startup innovation organizations</p>
            ...
            <Carousel className='m-12  z-0'
                ...
                focusOnSelect={true}
        >
                <div className='bg-black flex flex-col justify-evenly items-center m-8 sm:h-[400px] h-[600px] hover:bg-red-600 group hover:text-black '>
                    <img src={i1} alt="" />
                    <h1 className='text-white text-base sm:text-xl  font-bold'>Cloud Service</h1>
                ...
                <div className='bg-black flex flex-col justify-evenly items-center m-8 sm:h-[400px] h-[600px]  hover:bg-red-600 group hover: text-black '>
                    ...
                    <h1 className='text-white text-base sm:text-xl  font-bold'>CMS</h1>
                ...
                <div className='bg-black flex flex-col justify-evenly items-center m-8 sm:h-[400px] h-[600px] hover:bg-red-600 group hover: text-black '>
                    <img src={i3} alt="" />
                    <h1 className='text-white text-base sm:text-xl font-bold'>DevOps</h1>
                ...
                <div className='bg-black flex flex-col justify-evenly items-center m-8 sm:h-[400px] h-[600px] hover:bg-red-600 group hover: text-black '>
                    <img src={i4} alt="" />
                    <h1 className='text-white text-base sm:text-xl font-bold'>E-Commerce</h1>
                ...
                <div className='bg-black flex flex-col justify-evenly items-center m-8 sm:h-[400px] h-[600px]  hover:bg-red-600 group hover: text-black  '>
                    <img src={i5} alt="" />
                    <h1 className='text-white text-base sm:text-xl  font-bold'>Industry Solutions</h1>
                ...
                <div className='bg-black flex flex-col justify-evenly items-center m-8 sm:h-[400px] h-[600px]  hover:bg-red-600 group hover: text-black '>
                    <img src={i6} alt="" />
                    <h1 className='text-white text-base sm:text-xl  font-bold'> Internet Of Things</h1>
                ...
                <div className='bg-black flex flex-col justify-evenly items-center m-8 sm:h-[400px] h-[600px] hover:bg-red-600 group hover: text-black  '>
                    <img src={i7} alt="" />
                    <h1 className='text-white text-base sm:text-xl  font-bold text-center'> IT Infrastructure & Security</h1>
                ...
                <div className='bg-black flex flex-col justify-evenly items-center m-8 sm:h-[400px] h-[600px]  hover:bg-red-600 group hover: text-black '>
                    <img src={i8} alt="" />
                    <h1 className='text-white text-base sm:text-xl  font-bold'>Market Automation</h1>
